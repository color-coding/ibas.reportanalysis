...
public class ReportBook extends BusinessObject<ReportBook> implements IReportBook, IDataOwnership {
	 ...
	 * 指派类型 属性
	 */
	@DbField(name = "AssignedType", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 指派目标 属性
	 */
	@DbField(name = "Assigned", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	...
	protected void initialize() {
		...
		this.setAssigned(Strings.VALUE_EMPTY);
