...
@XmlType(name = ReportParameter.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
public class ReportParameter extends BusinessObject<ReportParameter> implements IReportParameter {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -5734057285934834923L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = ReportParameter.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_RA_RPT1";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "ReportParameter";
	...
	public static final IPropertyInfo<emReportParameterType> PROPERTY_CATEGORY = registerProperty(
			PROPERTY_CATEGORY_NAME, emReportParameterType.class, MY_CLASS);
	...
	public final emReportParameterType getCategory() {
	 ...
	 *            值
	 */
	public final void setCategory(emReportParameterType value) {
	 ...
	 * 参数说明 属性
	 */
	@DbField(name = "Description", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
