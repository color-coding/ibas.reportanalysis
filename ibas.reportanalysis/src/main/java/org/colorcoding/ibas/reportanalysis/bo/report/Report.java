...
public class Report extends BusinessObject<Report> implements IReport, IDataOwnership {
	 ...
	 * 查询语句 属性
	 */
	@DbField(name = "SqlString", type = DbFieldType.MEMO, table = DB_TABLE_NAME)
	 ...
	 * 服务器名称 属性
	 */
	@DbField(name = "Server", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 密码 属性
	 */
	@DbField(name = "Password", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 报表地址 属性
	 */
	@DbField(name = "Address", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 第三方应用 属性
	 */
	@DbField(name = "ThirdApp", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
