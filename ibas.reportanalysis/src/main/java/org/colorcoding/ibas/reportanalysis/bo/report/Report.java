...
public class Report extends BusinessObject<Report> implements IReport, IDataOwnership {
	 ...
	 * 报表名称 属性
	 */
	@DbField(name = "Name", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 关联的业务对象 属性
	 */
	@DbField(name = "BOCode", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 查询语句 属性
	 */
	@DbField(name = "SqlString", type = DataType.MEMO, table = DB_TABLE_NAME)
	 ...
	 * 服务器名称 属性
	 */
	@DbField(name = "Server", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 报表地址 属性
	 */
	@DbField(name = "Address", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 第三方应用 属性
	 */
	@DbField(name = "ThirdApp", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 追溯 属性
	 */
	@DbField(name = "Traced", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
